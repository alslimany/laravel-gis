...
class ProcessKMLJob implements ShouldQueue
{
    ...
    public function handle(DataImportService $importService): void
    {
        ...
        try {
            Log::info("Processing KML import", ['import_id' => $import->id]);
            ...
            $fileInfo = $importService->getFileInfo($filePath, 'kml');

            // Import to PostGIS
            $import->updateProgress(40);
            $importService->importToPostGIS($filePath, $tableName, 'kml');
            ...
            Log::info("Successfully processed KML import", [
                'import_id' => $import->id,
                'table_name' => $tableName,
            ]);
        } catch (Exception $e) {
            Log::error("Failed to process KML import", [
                'import_id' => $import->id,
                'error' => $e->getMessage(),
            ]);
    ...
    public function failed(\Throwable $exception): void
    {
        ...
        Log::error("Job failed to process KML import", [
