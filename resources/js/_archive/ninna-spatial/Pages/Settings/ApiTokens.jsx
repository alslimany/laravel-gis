...
import { DangerButton, Field, PageHeader, Panel, PrimaryButton, Table, TextInput, destroyResource, DataTable, thClass, tdClass, tdMuted, tdMono } from '../../Components/ui';
...
export default function Index({ tokens = [], plainTextToken = null }) {
    ...
    return (
        <AppLayout title="API tokens">
            ...
            <p className="mb-4 text-muted">Personal access tokens authenticate API requests with Authorization: Bearer.</p>
            <Panel>
                <DataTable>
                    <Table.Header>
                        <Table.Row>
