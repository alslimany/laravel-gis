...
import { ActionLink, DangerButton, Empty, PageHeader, Pager, Panel, PrimaryLink, RowActions, Table, destroyResource, DataTable, thClass, tdClass, tdMono } from '../../Components/ui';
                            ...
                            {rows.map((group) => (
                                <Table.Row key={group.id}>
                                    <Table.Cell className={tdClass}>
                                        ...
                                        {group.description ? <div className="text-[12px] text-base-600">{group.description}</div> : null}
                                    </Table.Cell>
