...
function basemapSource(id) {
    ...
    if (id === 'dark') {
        return new XYZ({ url: 'https://a.basemaps.cartocdn.com/dark_all/{z}/{x}/{y}.png', maxZoom: 19 });
    }
    if (id === 'light') {
        return new XYZ({ url: 'https://a.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png', maxZoom: 19 });
    }
    if (id === 'terrain') {
        return new XYZ({ url: 'https://a.tile.opentopomap.org/{z}/{x}/{y}.png', maxZoom: 17 });
    }
    return new OSM();
}
